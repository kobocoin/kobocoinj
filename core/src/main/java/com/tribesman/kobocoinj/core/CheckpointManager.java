...
import com.tribesman.kobocoinj.store.FullPrunedBlockStore;
 ...
 * {@link com.tribesman.kobocoinj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
