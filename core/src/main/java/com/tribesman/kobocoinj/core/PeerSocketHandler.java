...
import com.tribesman.kobocoinj.net.AbstractTimeoutHandler;
import com.tribesman.kobocoinj.net.MessageWriteTarget;
import com.tribesman.kobocoinj.net.StreamParser;
 ...
 * {@link com.tribesman.kobocoinj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link com.tribesman.kobocoinj.net.NioClient} or
     * {@link com.tribesman.kobocoinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
